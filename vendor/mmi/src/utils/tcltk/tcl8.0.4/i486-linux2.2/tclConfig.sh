...
TCL_DEFS=' -DHAVE_GETCWD=1 -DHAVE_UNISTD_H=1 -DUSE_TERMIOS=1 -DHAVE_SYS_TIME_H=1 -DTIME_WITH_SYS_TIME=1 -DHAVE_TZNAME=1 -DHAVE_TM_GMTOFF=1 -DHAVE_TIMEZONE_VAR=1 -DHAVE_ST_BLKSIZE=1 -DSTDC_HEADERS=1 -DNEED_MATHERR=1 -DRETSIGTYPE=void -DHAVE_SIGNED_CHAR=1 -DHAVE_SYS_IOCTL_H=1 -DHAVE_SYS_FILIO_H=1 '
...
# build directory.
TCL_BUILD_LIB_SPEC='-L/mmi-cad/utils/tcltk/tcl8.0/i486-linux2.2 -ltcl8.0${TCL_DBGX}'
...
# compiled.
TCL_SRC_DIR='/mmi-cad/utils/tcltk/tcl8.0'
