 ...
 *
 * RCS: @(#) $Id: tkCanvUtil.c,v 1.2 1999/02/04 02:28:31 doug Exp $
 */
    ...
    int offset;				/* Offset into item (ignored). */
{
    ...
    /* an acceptable inefficiency, IMHO -- Doug */
    Tk_DeleteAllTags(NULL, itemPtr, 0);
    for (i = 0; i < argc; i++) {
	Tk_AddTag(NULL, itemPtr, Tk_GetUid(argv[i]));
    }
