...
TK_LIBS='-L/usr/openwin/lib -lX11   -lsocket -lnsl -lm'
...
# build directory.
TK_BUILD_LIB_SPEC='-L/volume/mmi/utils/tcltk/tk8.0/hp9000-hpux10 -ltk8.0${TK_DBGX}'
...
# compiled.
TK_SRC_DIR='/volume/mmi/utils/tcltk/tk8.0'
