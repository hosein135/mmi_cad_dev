 ...
 *
 * RCS: @(#) $Id: tkCanvas.h,v 1.2 1999/02/04 02:27:57 doug Exp $
 */
...
typedef struct TkCanvas {
    ...
    Tk_Item *lastItemPtr;	/* Last in list of all items in canvas,
				 * or NULL if canvas empty. */
    Tcl_HashTable tagTable;	/* table for tag searches */
...
EXTERN void		Tk_DeleteTagFromPos _ANSI_ARGS_((TkCanvas *canvasPtr,
				Tk_Item *itemPtr, int tag));
EXTERN void		Tk_DeleteTag _ANSI_ARGS_((TkCanvas *canvasPtr,
				Tk_Item *itemPtr, Tk_Uid tag));
EXTERN void		Tk_DeleteAllTags _ANSI_ARGS_((TkCanvas *canvasPtr,
				Tk_Item *itemPtr, int ddts));
EXTERN void		Tk_AddTag _ANSI_ARGS_((TkCanvas *canvasPtr,
				Tk_Item *itemPtr, Tk_Uid tag));
