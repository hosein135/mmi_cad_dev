...
__declspec(dllexport)
    int __cdecl PurifyRed(void *addr, int size)
{
    avoidGy_19++;
    return 0;
}
...
__declspec(dllexport)
    int __cdecl PurifyGreen(void *addr, int size)
{
    avoidGy_20++;
    return 0;
}
...
__declspec(dllexport)
    int __cdecl PurifyYellow(void *addr, int size)
{
    avoidGy_21++;
    return 0;
}
...
__declspec(dllexport)
    int __cdecl PurifyBlue(void *addr, int size)
{
    avoidGy_22++;
    return 0;
}
...
__declspec(dllexport)
    int __cdecl PurifyMarkAsInitialized(void *addr, int size)
{
    avoidGy_23++;
    return 0;
}
...
__declspec(dllexport)
    int __cdecl PurifyMarkAsUninitialized(void *addr, int size)
{
    avoidGy_24++;
    return 0;
}
...
__declspec(dllexport)
    int __cdecl PurifyMarkForTrap(void *addr, int size)
{
    avoidGy_25++;
    return 0;
}
...
__declspec(dllexport)
    int __cdecl PurifyMarkForNoTrap(void *addr, int size)
{
    avoidGy_26++;
    return 0;
}
...
__declspec(dllexport)
    int __cdecl CoverageAddAnnotation(char *str)
{
    avoidGy_36++;
    return 0;
}
...
__declspec(dllexport)
    int __cdecl QuantifyAddAnnotation(char *str)
{
    avoidGy_48++;
    return 0;
}
