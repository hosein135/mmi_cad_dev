...
menu_add -menu local -label "Display Connections" \
    -command display_connections \
    -help "Annotates the connections between like named name_nets and I/O's in the current schematic."


proc display_connections {} -desc {
