...
# palette (old -- uses palette file now)
    ...
    pal_group col1 "hmetal" m4 v3 m3 v2
...
set DRC_DATA(connect,v0) {ndif pdif nwc pwc poly m1}
...
set DRC_DATA(enclose,poly,nfet) 0.36
set DRC_DATA(enclose,poly,pfet) 0.36
set DRC_DATA(enclose,ppls,pdif) 0.26
set DRC_DATA(enclose,ppls,pfet) 0.33
set DRC_DATA(enclose,ppls,pwc) 0.04
set DRC_DATA(layer_order) {m5 v4 m4 v3 m3 v2 m2 v1 m1 v0 poly nfet pfet ndif pdif nwc pwc nw ppls npls prb}
set DRC_DATA(space_to,v0_ndif,nfet) 0.22
set DRC_DATA(space_to,v0_pdif,pfet) 0.22
set DRC_DATA(space_to,v0_poly,nfet) 0.28
set DRC_DATA(space_to,v0_poly,pfet) 0.28
