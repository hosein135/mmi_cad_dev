...
C_16 net_9 gnd 3.83536fF
C_17 net_10 gnd 2.86308fF
C_18 net_11 gnd 1.10762fF
C_19 out gnd 1.33656fF
C_20 gnd gnd 6.57899fF
Mp_1 vdd in0 net_1 vdd p W=1.84U L=0.18U AD=0.734063P PD=3.62105U 
+ AS=0.4968P PS=2.38U
...
+ PS=2.38U
Mp_4 net_4 in1 vdd vdd p W=1.84U L=0.18U AD=0.4968P PD=2.38U AS=0.734063P 
+ PS=3.62105U
Mp_5 vdd sel0 net_3 vdd p W=1.84U L=0.18U AD=0.734063P PD=3.62105U 
+ AS=0.8832P PS=4.64U
Mp_6 vdd in2 net_5 vdd p W=1.84U L=0.18U AD=0.734063P PD=3.62105U 
+ AS=0.5043P PS=3.17U
...
+ PS=2.445U
Mp_9 net_7 in3 vdd vdd p W=1.84U L=0.18U AD=0.5566P PD=2.445U AS=0.734063P 
+ PS=3.62105U
Mp_10 vdd net_2 net_8 vdd p W=1.84U L=0.18U AD=0.734063P PD=3.62105U 
+ AS=0.4968P PS=2.38U
...
+ AS=0.734063P PS=3.62105U
Mp_14 net_10 sel1 vdd vdd p W=0.92U L=0.18U AD=0.4416P PD=2.8U AS=0.367032P 
+ PS=1.81053U
Mp_15 vdd net_9 out vdd p W=1.84U L=0.18U AD=0.734063P PD=3.62105U 
+ AS=0.4968P PS=2.38U
Mp_16 out net_9 vdd vdd p W=1.84U L=0.18U AD=0.4968P PD=2.38U AS=0.734063P 
+ PS=3.62105U
Mn_1 gnd in0 net_1 gnd n W=0.92U L=0.18U AD=0.350189P PD=2.56U AS=0.2484P 
+ PS=1.46U
...
+ PS=1.46U
Mn_4 net_4 in1 gnd gnd n W=0.92U L=0.18U AD=0.2484P PD=1.46U AS=0.350189P 
+ PS=2.56U
Mn_5 gnd sel0 net_3 gnd n W=0.92U L=0.18U AD=0.350189P PD=2.56U AS=0.3616P 
+ PS=3.44U
Mn_6 gnd in2 net_5 gnd n W=0.92U L=0.18U AD=0.350189P PD=2.56U AS=0.26515P 
+ PS=2.435U
...
+ PS=1.46U
Mn_10 net_7 in3 gnd gnd n W=0.92U L=0.18U AD=0.2484P PD=1.46U AS=0.350189P 
+ PS=2.56U
Mn_11 gnd net_2 net_8 gnd n W=0.92U L=0.18U AD=0.350189P PD=2.56U 
+ AS=0.4473P PS=3.21U
...
+ AS=0.350189P PS=2.56U
Mn_14 net_10 sel1 gnd gnd n W=0.46U L=0.18U AD=0.2208P PD=1.88U 
+ AS=0.175095P PS=1.28U
Mn_15 gnd net_9 out gnd n W=0.92U L=0.18U AD=0.350189P PD=2.56U AS=0.2484P 
+ PS=1.46U
Mn_16 out net_9 gnd gnd n W=0.92U L=0.18U AD=0.2484P PD=1.46U AS=0.350189P 
+ PS=2.56U
.ENDS	$ MMI_MUXI4C
