 ...
 *     *********************************************************************
 *
 * rcsid $Header: mzrouter.h,v 6.1 90/08/28 19:36:06 mayo Exp $
 */
...
#endif
#ifndef _DOUBLEINT
int err2 = Need_to_include_doubleint_header;
#endif
#ifndef _LIST
...
typedef struct rpath
{
    ...
    DoubleInt		 rp_cost;	/* estimated total cost */
    DoubleInt            rp_togo;	/* estimated cost to completion */
} RoutePath;
...
#define EC_UP		4
#define EC_DOWN		8
#define EC_CONTACTS	16
#define EC_ALL		31

#define EC_WALKRIGHT	32
#define EC_WALKLEFT	64
#define EC_WALKUP	128
#define EC_WALKDOWN	256
#define EC_WALKCONTACT	512

#define EC_COMPLETE	1024
 ...
 * 	 To multiply doubleint by routeFloat, first multiply by mantissa, 
 *       then shiftright nExponent number of bits.
 */
...
typedef struct mazeparameters
{
    ...
    DoubleInt mp_wWidth;	/* Window width */
    DoubleInt mp_wRate;		/* Rate of motion for window */
    DoubleInt mp_bloomDeltaCost; /* Max increment. in cost while blooming */
    ...
    bool mp_expandDests;	/* If set, routes may terminate anywhere
...
extern Void MZTechFinal();
    ...
    /* "drc" section */
extern Void MZDRCInit();
extern bool MZDRCLine();
