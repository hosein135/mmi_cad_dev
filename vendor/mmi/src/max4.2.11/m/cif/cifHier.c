...
CIFInitCells(void)
{
    ...
    DBCellUseSetTrans (CIFTotalUse, &GeoIdentityTransform);
    ...
    DBCellUseSetTrans (CIFComponentUse, &GeoIdentityTransform);
    ...
    DBCellUseSetTrans (CIFDummyUse, &GeoIdentityTransform);
}

/*
 * ----------------------------------------------------------------------------
