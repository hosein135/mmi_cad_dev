 ...
 * after DBCellNewUse() BUT before DBInstanceAdd().
 *
 * ----------------------------------------------------------------------------
 */
...
void
DBArrayOverlap(register CellUse *cu, Rect *parentRect, int *pxlo, int *pxhi, int *pylo, int *pyhi)
                         	/* Pointer to cell use which may be an array */
                     		/* Clipping rectangle cu->cu_parent coords */
...
void
DBComputeArrayArea(Rect *area, CellUse *cellUse, int x, int y, Rect *prect)
