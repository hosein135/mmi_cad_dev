...
int ntlTile2InstFunc(Tile * tile, HierArg * ha )
{
    Rect r;
 ...
 * ----------------------------------------------------------------------------
 */
int ntlHierTileFunc(CellUse * use, ClientData none)
{
    Rect  r;
    int	  pNum;
    HierArg ha;
    CellDef * ParentDef = use->cu_parent;
 ...
 *
 * Step 3) array element to array element 
