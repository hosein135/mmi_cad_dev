 ...
 * Allows hashing of existing strucs without creating parallel strucs
 * to hold keys etc.  
 *
 * The strucs to be hashed must have "key" and "next" fields.  The offsets
...
/* The IHashTable struc should not be manipulated directly by clients */
