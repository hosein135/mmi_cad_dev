...
/* variables for communciation between func and LayChangedHighlight */
...
void
LayChangedHighlight(CellDef *rootDef, 
...
void
LayChangedSelection(CellDef *rootDef, Rect *area, int erase)
{

    /* mark areas that require redisplay */
    LayChangedHighlight(rootDef, area, erase);
}
 ...
 */
void
layChangedHLBox(CellDef *rootDef,
		         /* box root def */
		bool erase)
