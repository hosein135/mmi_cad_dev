...
#define	extInMask(bp, tbl) \
    TTMaskHasType(&tbl[DBgetTileType((bp)->b_inside)], DBgetTileType((bp)->b_outside))
...
int
extEnumTilePerim(register Tile *tpIn, TileTypeBitMask mask, int (*func) (/* ??? */), ClientData cdata)
