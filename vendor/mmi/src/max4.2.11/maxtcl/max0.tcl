...
set RCSVERSION(max0.tcl) { $Revision: 1.25 $ }
...
###
### NOTE:  only source files, if we are working from disk.
###
...
proc max_parse_args0 {} -desc {
  ...
  # This call should be identical to the one in max_parse_args in max.tcl
  set args_left [call_keyword $argv {{tech ""} {technology ""}}]
