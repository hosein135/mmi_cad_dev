...
/* PROCEDURES */
extern void HeapInit(Heap *heap, 
		     int size, 
		     int descending, 
		     int stringIds);

extern void  HeapInitType(Heap *heap, 
			  int size, 
			  int descending, 
			  int stringIds, 
			  int keyType);

extern void HeapKill(Heap *heap, void (*func) (/* ??? */));
extern void HeapFreeIdFunc(register Heap *heap, int i);
extern void HeapAdd(Heap *heap, 
		    union heUnion *pKey, 
		    char *id); 
extern void HeapDump(Heap *heap);
extern HeapEntry *HeapRemoveTop(register Heap *heap, HeapEntry *entry);
extern HeapEntry *HeapLookAtTop(register Heap *heap);
