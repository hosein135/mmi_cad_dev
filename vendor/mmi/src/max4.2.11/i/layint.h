...
/* flyline text size (0-3, -1=off) */
extern int layFlyLineTextSize;
...
extern void layAnnotateTextDelete(Layout *w, int n, bool notify);
...
extern void layChangedHLBox(CellDef *rootDef, bool erase);
 ...
 *     2.  By layChangedHLBox() with mode LDB_CHANGED to mark old box for erasure.
 */
