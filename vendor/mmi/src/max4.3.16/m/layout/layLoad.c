               		...
               		/* Name of new cell to be bound to this window */
{
	...
	/* TODO (this is too expensive and not needed as long
	   as we have only one window. 
	...
	*/
     ...
     */
    if(oldRootUse) DBCellUseDelete(oldRootUse);
}
