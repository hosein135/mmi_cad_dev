...
{
  char *ts_name;        
  int ts_index;            /* index of this entery in text style table */
  int ts_maxHeight;        /* max height in pixels */
  int ts_maxHeightDB;      /* if positive, max height in database units */
  double ts_maxCoverage;   /* if positive, max fraction of window text may 
			      obscure */
  double ts_maxOverlap;     /* if positive, max fraction of text that may
			    * overlap other text */
  bool ts_visible;         /* if not set this style is not displayed */
} TextStyle;

#define LAY_TEXT_STYLE_TABLE_SIZE 100
extern int layTextStyleMax;
extern TextStyle layTextStyleTable[]; 

extern TextStyle *layTextStyleLabelSmall;
extern TextStyle *layTextStyleLabelMedium;
extern TextStyle *layTextStyleLabelLarge;
extern TextStyle *layTextStyleLabelExtraLarge;
extern TextStyle *layTextStyleFlyline;
extern TextStyle *layTextStyleAnnotationSmall;
extern TextStyle *layTextStyleAnnotationMedium;
extern TextStyle *layTextStyleAnnotationLarge;
extern TextStyle *layTextStyleAnnotationExtraLarge;
...
typedef struct layout {
  ...
  TextAnnotation *lay_textAnnotations[LAY_TEXT_STYLE_TABLE_SIZE];
...
extern void LayChangedDefSelection(CellDef *rootDef, Rect *area, int erase);
extern void LayChangedDefHL(CellDef *rootDef, Rect *area, int erase);
extern bool LayChangedDef(CellDef *rootDef, Rect *area, TileTypeBitMask *layers);
