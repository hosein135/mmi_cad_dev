 ...
 */
static void
ntlTile2InstExplPorts(NodeRecord  * intNode, 
		      TileType intType,
		      Rect * overlapRect, 
		      HierArg * ha)
{
 ...
 */
static void 
ntlTile2InstImplPorts(NodeRecord  * intNode, 
		      TileType intType,
		      Rect * overlapRect, 
		      HierArg * ha)
{
...
static int 
ntlTile2PortsFunc(Tile * intTile, HierArg * ha)
{
...
/*
if(ntlVerbose)
MsgInfoF("ntlTile2PortsFunc: use1 =  %s, use2 = %s, ha_pass2 = %d\n", 
ha->ha_use1->cu_id, 
(ha->ha_use2 == NULL) ? "(NULL)" : ha->ha_use2->cu_id,
ha->ha_pass2);
 */
 ...
 */
     ...
     * invert to get transform from coord of def containing use1.
