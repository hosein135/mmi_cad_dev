...
/* text font sizes */
extern int GrMaxFontSize;  /* sizes range from zero to this */

#define GR_TEXT_SMALL 4
#define GR_TEXT_MEDIUM 8
#define GR_TEXT_LARGE 12
#define GR_TEXT_XLARGE 16
...
extern int GrFontHeightToIndex(int height);
extern int GrFontWidthToIndex(int width);
extern int GrFontIndexToHeight(int font);    
extern int GrFontIndexToWidth(int font);    
...
extern void GrSetFontSizeNew(int height, int width);
