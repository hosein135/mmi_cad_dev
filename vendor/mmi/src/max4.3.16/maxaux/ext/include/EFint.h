 ...
 *     *********************************************************************
 *
 * rcsid $Header: EFint.h,v 6.0 90/08/28 18:13:35 mayo Exp $
 */
...
typedef struct conn
{
    ...
    int		 conn_value;	/* Value of capacitance (attofarads) or
...
typedef struct def
{
    ...
    int		 def_scale;	/* Multiply all dimensions by this */
