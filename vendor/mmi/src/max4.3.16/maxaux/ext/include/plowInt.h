 ...
 *     *********************************************************************
 *
 * Needs to include: magic.h, geometry.h, tiles.h
 *
 * rcsid $Header: plowInt.h,v 6.0 90/08/28 18:53:38 mayo Exp $
 */
...
#endif	_GEOMETRY
#ifndef	_TILES
	int err2 = Need_to_include_tiles_header;
#endif	_TILES
...
typedef struct
{
    ...
    Void	       (*rte_proc)();	/* Procedure implementing rule */
 ...
 */
#define	TRAIL_UNINIT	MINFINITY
#define	TRAILING(tp)	(( ((int) (tp)->ti_client) == TRAIL_UNINIT) \
