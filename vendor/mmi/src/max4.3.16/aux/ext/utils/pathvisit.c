...
#ifndef lint
static char rcsid[] = "$Header: pathvisit.c,v 6.0 90/08/28 19:01:14 mayo Exp $";
#endif  not lint
...
PaVisitInit()
{
    ...
    MALLOC(PaVisit *, pv, sizeof (PaVisit));
    ...
    ClientData cdata;
{
    ...
    MALLOC(PaVisitClient *, pvc, sizeof (PaVisitClient));
