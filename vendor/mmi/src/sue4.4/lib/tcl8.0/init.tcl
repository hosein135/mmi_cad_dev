...
proc unknown args {
	...
	if {$ret != 0} {
	    ...
	    # This can happen if you forget to use michaels new "improved"
	...
	# mha - catch "info commands" since MMI version may not work here
	# pat added to Tcl8.0
...
proc auto_reset {} {
    ...
    # mha - modified to not use unrestricted "info procs" 
    # pat added to Tcl8.0
